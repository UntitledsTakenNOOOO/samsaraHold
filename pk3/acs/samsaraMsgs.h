...
int ClassPickupMessages[CLASSCOUNT][SLOTCOUNT][MSGCOUNT] = 
{
    ...
    },
    {
        ...
        },
        {
            ...
            "The second barrel is now being used, at the cost both of them sucking.",
...
int ClassUniqueMessages[CLASSCOUNT][MSGCOUNT] =
{
    ...
    },
    {
        ...
        "But hey, in Stronghold, you have extra lives!",
        "So does that make this an extra-extra life?",
    },
    {
        "MYSTIC AMBIT INCANT",
        "Heal plz.",
    ...
    },
    {
        ...
        "Oh gosh darnit even the unique is ranged.",
...
int PunchDrunkUniqueMessages[CLASSCOUNT][MSGCOUNT] =
{
    ...
    },
    {
        ...
        "Because kicking now causes explosions.",
    },
    {
